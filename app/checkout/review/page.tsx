    ...
    try {
      ...
      if (savedConfig) {
        try {
          ...
          console.log(
            "RMX Review: using rmx_checkout_config",
            currentOrder
          );
        } catch (error) {
          console.error(
      ...
      if (!currentOrder) {
        ...
        if (savedSessionOrder) {
          try {
            ...
            console.log(
              "RMX Review: using sessionStorage",
              currentOrder
            );
          } catch (error) {
            console.error(
      ...
      if (!currentOrder) {
        ...
        if (savedOrder) {
          try {
            ...
            console.log(
              "RMX Review: using old order storage",
              currentOrder
            );
          } catch (error) {
            console.error(
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Please check your personalized
          lamp, delivery details, and
          order total before continuing
          to payment.
        </p>
